...
export const CategoryForm: React.FC<CategoryFormProps>=({
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error("Assurez-vous d'abord d'avoir supprimé tous les produits de cette catégorie.");
    } finally {
      setLoading(false);
      setOpen(false);
    }
    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
      ...
      <div className="grid grid-cols-3 gap-8">
        <FormField
         ...
         render={({field})=>(
          <FormItem>
            ...
            <FormControl>
              <Input disabled={loading} placeholder="Nom du catégorie" {...field}/>
            </FormControl>
            <FormMessage/>
        ...
        />
         ...
         render={({field})=>(
          <FormItem>
            <FormLabel>Panneau publicitaire</FormLabel>
            <FormControl>
              <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value} >
                 <FormControl>
                   <SelectTrigger >
                    ...
                    placeholder="Choisir un panneau publicitaire"/>
